...
for narrator in narrators:
    ...
    # use full data set to train (and to test, although test predictions are ignored)
    preds, selected_features, clf = pu.svm_classify(contents_train, y_train, contents_train, k="all")
    coefs = clf.coef_.toarray()

    # preds, selected_features, clf = pu.nb_classify(contents_train, y_train, contents_train,k="all")
    ...
    # don't care about classification report
